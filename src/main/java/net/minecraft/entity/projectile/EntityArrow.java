...
public class EntityArrow extends Entity implements IProjectile {
    ...
    private int inData;
    @Getter private boolean inGround;
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
        ...
        this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70186_3_, var10) * 180.0D / Math.PI);
    ...
    public void setVelocity(double p_70016_1_, double p_70016_3_, double p_70016_5_) {
        ...
        if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
            ...
            this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70016_3_, var7) * 180.0D / Math.PI);
