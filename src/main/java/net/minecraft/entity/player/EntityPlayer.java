...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender {
    ...
    private Cosmetic playerCapes = null;
    private Cosmetic playerWings = null;
    ...
    public float lIIlIlIllllllIllllIIllllI = 0.0f;
    ...
    public Cosmetic getPlayerCape() {
        return this.playerCapes;
    }

    public boolean hasCape() {
        return this.playerCapes != null;
    }

    public boolean hasWings() {
        return this.playerWings != null;
    }

    public void setCBCape(Cosmetic cosmetic) {
        this.playerCapes = cosmetic;
    }

    public Cosmetic getWings() {
        return this.playerWings;
    }

    public void setCBWings(Cosmetic cosmetic) {
        this.playerWings = cosmetic;
    }
    ...
    public EntityPlayer(World p_i45324_1_, GameProfile p_i45324_2_) {
        ...
        this.setLocationAndAngles((double)var3.posX + 0.5D, var3.posY + 1, (double)var3.posZ + 0.5D, 0.0F, 0.0F);
    ...
    public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_) {
        if (p_146097_1_ == null) {
            ...
            if (p_146097_2_) {
                ...
                var5 = 0.3F;
                var4.motionX = -MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var5;
                var4.motionZ = MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var5;
                var4.motionY = -MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI) * var5 + 0.1F;
                var5 = 0.02F;
                var6 = this.rand.nextFloat() * (float)Math.PI * 2.0F;
                var5 *= this.rand.nextFloat();
                var4.motionX += Math.cos(var6) * (double)var5;
            ...
            if (!p_71059_1_.hitByEntity(this)) {
                ...
                if (var2 > 0.0F || var4 > 0.0F) {
                    ...
                    if (var8) {
                        int i;
                        if (var3 > 0) {
                            p_71059_1_.addVelocity(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * (float)var3 * 0.5F, 0.1D, MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * (float)var3 * 0.5F);
                            this.motionX *= 0.6D;
                            this.motionZ *= 0.6D;
                            this.setSprinting(false);
                        }
                        boolean override = Minecraft.getMinecraft().isSingleplayer() ? (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.damaged.getValue().equals("Override") : (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.attacking.getValue().equals("Override");
                        boolean vanilla = Minecraft.getMinecraft().isSingleplayer() ? (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.damaged.getValue().equals("Vanilla") : (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.attacking.getValue().equals("Vanilla");

                        if (var5 || CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && CheatBreaker.getInstance().getModuleManager().particlesMod.critParticles.getValue().equals("Always") && !vanilla) {
                            if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && !vanilla) {
                                if (!CheatBreaker.getInstance().getModuleManager().particlesMod.critParticles.getValue().equals("Never") && override) {
                                    EntityCrit2FX var1 = new EntityCrit2FX(Minecraft.getMinecraft().theWorld, p_71059_1_, "crit", (Float) CheatBreaker.getInstance().getModuleManager().particlesMod.critParticlesMultiplier.getValue());
                        ...
                        if (var4 > 0.0F || CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticles.getValue().equals("Always") && !vanilla) {
                            if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && !vanilla) {
                                if (!CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticles.getValue().equals("Never") && override) {
                                    EntityCrit2FX var1 = new EntityCrit2FX(Minecraft.getMinecraft().theWorld, p_71059_1_, "magicCrit", (Float) CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticlesMultiplier.getValue());
                                    Minecraft.getMinecraft().effectRenderer.addEffect(var1);
                                }
                            } else {
    ...
    public EntityPlayer.EnumStatus sleepInBedAt(int p_71018_1_, int p_71018_2_, int p_71018_3_) {
        ...
        if (this.worldObj.blockExists(p_71018_1_, p_71018_2_, p_71018_3_)) {
            ...
            this.setPosition((float)p_71018_1_ + var10, (float)p_71018_2_ + 0.9375F, (float)p_71018_3_ + var7);
        } else {
            this.setPosition((float)p_71018_1_ + 0.5F, (float)p_71018_2_ + 0.9375F, (float)p_71018_3_ + 0.5F);
        }
        ...
        if (this.capabilities.allowEdit) {
            ...
            if (var4.getMaterial() != Material.air) {
                ...
                if (this.getCurrentEquippedItem() != null) {
                    ...
                    return var5.func_150998_b(var4) || var5.func_150997_a(var4) > 1.0F;
                }
            }
