            ...
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag || CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && CheatBreaker.getInstance().getModuleManager().particlesMod.critParticles.getValue().equals("Always") && !vanilla) {
                            if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && !vanilla) {
                                if (!CheatBreaker.getInstance().getModuleManager().particlesMod.critParticles.getValue().equals("Never") && override) {
                                    float multiplierValue = (float) CheatBreaker.getInstance().getModuleManager().particlesMod.critParticlesMultiplier.getValue();
                                    Minecraft.getMinecraft().effectRenderer.emitParticleAtEntity(targetEntity, EnumParticleTypes.CRIT, multiplierValue);
                                }
                            } else {
                        ...
                        if (f1 > 0.0F || CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticles.getValue().equals("Always") && !vanilla) {
                            if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() && !vanilla) {
                                if (!CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticles.getValue().equals("Never") && override) {
                                    float multiplierValue = (float) CheatBreaker.getInstance().getModuleManager().particlesMod.sharpnessParticlesMultiplier.getValue();
                                    Minecraft.getMinecraft().effectRenderer.emitParticleAtEntity(targetEntity, EnumParticleTypes.CRIT_MAGIC, multiplierValue);
                                }
                            } else {
