...
public abstract class EntityMob extends EntityCreature implements IMob {
    ...
    public boolean attackEntityAsMob(Entity p_70652_1_) {
        ...
        if (var4) {
            if (var3 > 0) {
                p_70652_1_.addVelocity(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * (float)var3 * 0.5F, 0.1D, MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * (float)var3 * 0.5F);
                this.motionX *= 0.6D;
                this.motionZ *= 0.6D;
            }
