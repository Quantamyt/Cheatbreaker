        ...
        if (p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_) && var11 == Blocks.end_portal_frame && !BlockEndPortalFrame.func_150020_b(var12)) {
            if (p_77648_3_.isClient) {
                ...
                for (var13 = 0; var13 < 16; ++var13) {
                    double var14 = (float)p_77648_4_ + (5.0F + itemRand.nextFloat() * 6.0F) / 16.0F;
                    double var16 = (float)p_77648_5_ + 0.8125F;
                    double var18 = (float)p_77648_6_ + (5.0F + itemRand.nextFloat() * 6.0F) / 16.0F;
                    double var20 = 0.0D;
                    double var22 = 0.0D;
                    double var24 = 0.0D;
