...
public class StatList {
    ...
    public static StatBase field_151185_q = (new StatBasic("stat.horseOneCm", new ChatComponentTranslation("stat.horseOneCm"), StatBase.distanceStatType)).initIndependentStat().registerStat();
    ...
    public static StatBase field_151183_A = (new StatBasic("stat.junkFished", new ChatComponentTranslation("stat.junkFished"))).registerStat();
    public static StatBase field_151184_B = (new StatBasic("stat.treasureFished", new ChatComponentTranslation("stat.treasureFished"))).registerStat();
    ...
    private static void initCraftableStats() {
        ...
        while (var1.hasNext()) {
            ...
            if (var5 != null) {
                ...
                objectCraftStats[var3] = (new StatCrafting("stat.craftItem." + var3, new ChatComponentTranslation("stat.craftItem", (new ItemStack(var5)).func_151000_E()), var5)).registerStat();
            }
        }
        ...
        while (var0.hasNext()) {
            ...
            if (Item.getItemFromBlock(var1) != null) {
                ...
                if (var1.getEnableStats()) {
                    mineBlockStatArray[var2] = (new StatCrafting("stat.mineBlock." + var2, new ChatComponentTranslation("stat.mineBlock", (new ItemStack(var1)).func_151000_E()), Item.getItemFromBlock(var1))).registerStat();
    ...
    private static void initStats() {
        ...
        while (var0.hasNext()) {
            ...
            if (var1 != null) {
                ...
                objectUseStats[var2] = (new StatCrafting("stat.useItem." + var2, new ChatComponentTranslation("stat.useItem", (new ItemStack(var1)).func_151000_E()), var1)).registerStat();
        ...
        while (var0.hasNext()) {
            ...
            if (var1 != null) {
                ...
                if (var1.isDamageable()) {
                    objectBreakStats[var2] = (new StatCrafting("stat.breakItem." + var2, new ChatComponentTranslation("stat.breakItem", (new ItemStack(var1)).func_151000_E()), var1)).registerStat();
                }
            }
        }
    ...
    public static StatBase func_151182_a(EntityList.EntityEggInfo p_151182_0_) {
        ...
        return var1 == null ? null : (new StatBase("stat.killEntity." + var1, new ChatComponentTranslation("stat.entityKill", new ChatComponentTranslation("entity." + var1 + ".name")))).registerStat();
    }
