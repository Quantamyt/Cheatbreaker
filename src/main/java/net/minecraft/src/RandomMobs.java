...
public class RandomMobs {
    ...
    private static void updateEntityVillager(EntityVillager ev, EntityVillager evs) {
        int profSev = evs.getProfession();
        ...
        if (working) {
            ...
            try {
                ...
                if (entity instanceof EntityLiving) {
                    ...
                    var5 = props.getTextureLocation(loc, entityLiving1);
                    return var5;
                }
