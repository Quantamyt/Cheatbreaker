...
public class CustomColorizer {
    ...
    public static boolean updateLightmap(World world, float torchFlickerX, int[] lmColors, boolean nightvision) {
        if (world == null) {
            ...
            return false;
        } else if ((Boolean) CheatBreaker.getInstance().getGlobalSettings().enableFpsBoost.getValue() && (Boolean) CheatBreaker.getInstance().getGlobalSettings().fullBright.getValue()) {
            return false;
                ...
                if (lightMapRgb == null) {
                    ...
                    if (nightvision && height < 64) {
                        ...
                        if (width < 16) {
                            ...
                            float gamma = Config.limitTo1(Config.getGameSettings().getGamma());
