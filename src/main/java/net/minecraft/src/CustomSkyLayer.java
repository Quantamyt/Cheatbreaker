...
public class CustomSkyLayer {
    ...
    private void renderSide(Tessellator tess, int side) {
        ...
        tess.addVertexWithUV(-70.0D, -70.0D, -70.0D, tx, ty);
        tess.addVertexWithUV(-70.0D, -70.0D, 70.0D, tx, ty + 0.5D);
        tess.addVertexWithUV(70.0D, -70.0D, 70.0D, tx + 0.3333333333333333D, ty + 0.5D);
        tess.addVertexWithUV(70.0D, -70.0D, -70.0D, tx + 0.3333333333333333D, ty);
        tess.draw();
    }
