...
public class Reflector {
    ...
    public static ReflectorClass FMLRenderAccessLibrary = findReflectorClass(new String[] {"FMLRenderAccessLibrary", "net.minecraft.src.FMLRenderAccessLibrary"});
    ...
    public static ReflectorMethod ForgeWorld_finishSetup = new ReflectorMethod(ForgeWorld, "finishSetup");
    ...
    public static ReflectorClass ItemBlock = new ReflectorClass(ItemBlock.class);
    public static ReflectorField ItemBlock_block = new ReflectorField(ItemBlock, Block.class, 0);
    public static ReflectorClass ItemRenderer = new ReflectorClass(ItemRenderer.class);
    public static ReflectorField ItemRenderer_itemToRender = new ReflectorField(ItemRenderer, ItemStack.class);
    ...
    private static ReflectorClass findReflectorClass(String[] strings) {
        ReflectorClass rcFirst = null;

        for (int i = 0; i < strings.length; ++i) {
            String className = strings[i];
            ReflectorClass rc = new ReflectorClass(className);
