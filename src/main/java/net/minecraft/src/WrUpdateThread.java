...
public class WrUpdateThread extends Thread {
    ...
    public void run() {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass178628546)null);
    ...
    static class NamelessClass178628546 {
    }
    ...
    private class ThreadUpdateControl implements IWrUpdateControl {
        ...
        ThreadUpdateControl(WrUpdateThread.NamelessClass178628546 x1) {
            this();
        }
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener {
        ...
        private ThreadUpdateListener() {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass178628546)null);
        }
        ...
        ThreadUpdateListener(WrUpdateThread.NamelessClass178628546 x1) {
            this();
        }
    }
}
