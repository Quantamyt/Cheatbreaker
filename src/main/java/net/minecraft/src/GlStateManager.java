...
public class GlStateManager {
    ...
    public static int GL_FRAMEBUFFER = OpenGlHelper.field_153198_e;
    public static int GL_RENDERBUFFER = OpenGlHelper.field_153199_f;
    public static int GL_COLOR_ATTACHMENT0 = OpenGlHelper.field_153200_g;
    public static int GL_DEPTH_ATTACHMENT = OpenGlHelper.field_153201_h;
