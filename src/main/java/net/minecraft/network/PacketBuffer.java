...
public class PacketBuffer extends ByteBuf {
    ...
    public String readStringFromBuffer(int maxLength) {
        try {
            ...
            if (n2 > maxLength * 4) {
                ...
                throw new IOException("The received encoded string buffer length is longer than maximum allowed (" + n2 + " > " + maxLength * 4 + ")");
            ...
            if (string.length() > maxLength) {
                throw new IOException("The received string length is longer than maximum allowed (" + n2 + " > " + maxLength + ")");
            }
            return string;
        } catch (IOException e) {
            e.printStackTrace();
     ...
     */
    public void writeStringToBuffer(String p_150785_1_) {
