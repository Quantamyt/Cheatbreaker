    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer {
        ...
        public ServerStatusResponse deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            ...
            if (var4.has("description")) {
                var5.func_151315_a(p_deserialize_3_.deserialize(var4.get("description"), IChatComponent.class));
            }

            if (var4.has("players")) {
                var5.func_151319_a(p_deserialize_3_.deserialize(var4.get("players"), PlayerCountData.class));
            }

            if (var4.has("version")) {
                var5.func_151321_a(p_deserialize_3_.deserialize(var4.get("version"), MinecraftProtocolVersionIdentifier.class));
            }

            if (var4.has("favicon")) {
                var5.func_151320_a(JsonUtils.getJsonObjectStringFieldValue(var4, "favicon"));
            }
            if (var4.has("lcServer")) {
                var5.lcString = var4.get("lcServer").getAsString();
            }
            return var5;
        }
