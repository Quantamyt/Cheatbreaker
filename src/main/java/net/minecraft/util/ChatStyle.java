        ...
        public ChatStyle deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (var5 == null) {
                    ...
                    if (var5.has("color")) {
                        var4.color = p_deserialize_3_.deserialize(var5.get("color"), EnumChatFormatting.class);
                    }
                    ...
                    if (var5.has("hoverEvent")) {
                        ...
                        if (var6 != null) {
                            ...
                            IChatComponent var12 = p_deserialize_3_.deserialize(var6.get("value"), IChatComponent.class);
