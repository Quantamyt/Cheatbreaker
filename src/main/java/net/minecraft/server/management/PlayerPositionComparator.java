...
public class PlayerPositionComparator implements Comparator {
    ...
    public int compare(EntityPlayerMP p_compare_1_, EntityPlayerMP p_compare_2_) {
        double var3 = p_compare_1_.getDistanceSq(this.theChunkCoordinates.posX, this.theChunkCoordinates.posY, this.theChunkCoordinates.posZ);
        double var5 = p_compare_2_.getDistanceSq(this.theChunkCoordinates.posX, this.theChunkCoordinates.posY, this.theChunkCoordinates.posZ);
