...
public class ServerList {
    ...
    public void saveServerList() {
        try {
            ...
            for (ServerData server : this.servers) {
                if (server.dontSave) continue;
                var1.appendTag(server.getNBTCompound());
            }
    ...
    public void swapServers(int p_78857_1_, int p_78857_2_) {
        ...
        if (!var3.dontSave && !var4.dontSave) {
    ...
    public void func_147413_a(int p_147413_1_, ServerData p_147413_2_) {
        this.servers.set(p_147413_1_ -= CheatBreaker.getInstance().getGlobalSettings().getPinnedServers().size(), p_147413_2_);
    }
