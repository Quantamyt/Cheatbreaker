...
public class PlayerControllerMP {
    ...
    public boolean onPlayerRightClick(EntityPlayer p_78760_1_, World p_78760_2_, ItemStack p_78760_3_, int p_78760_4_, int p_78760_5_, int p_78760_6_, int p_78760_7_, Vec3 p_78760_8_) {
        ...
        boolean var12 = (!p_78760_1_.isSneaking() || p_78760_1_.getHeldItem() == null) && p_78760_2_.getBlock(p_78760_4_, p_78760_5_, p_78760_6_).onBlockActivated(p_78760_2_, p_78760_4_, p_78760_5_, p_78760_6_, p_78760_1_, p_78760_7_, var9, var10, var11);
    ...
    public void attackEntity(EntityPlayer p_78764_1_, Entity p_78764_2_) {
        if (p_78764_1_ == this.mc.thePlayer) {
            Vec3 distance = this.mc.renderViewEntity.getPosition(1.0F);
            ModuleReachDisplay.lastRange = this.mc.objectMouseOver.hitVec.distanceTo(distance);
            ModuleReachDisplay.lastAttackTime = System.currentTimeMillis();
        }
