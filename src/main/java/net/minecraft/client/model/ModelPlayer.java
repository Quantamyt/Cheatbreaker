...
import com.cheatbreaker.client.cosmetic.type.model.CosmeticModelWings;
...
public class ModelPlayer extends ModelBiped {
    ...
    private CosmeticModelWings dragonWingsBiped;
    ...
    public ModelPlayer(float p_i46304_1_, boolean p_i46304_2_) {
        ...
        this.dragonWingsBiped = new CosmeticModelWings(0.0f);
    }
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        if (!this.aimedBow && entityIn instanceof EntityPlayer && (entityPlayer = (EntityPlayer) entityIn).hasWings()) {
            if (entityPlayer.getWings().getType() == Cosmetic.CosmeticType.WINGS && (Boolean) CheatBreaker.getInstance().getGlobalSettings().showCheatBreakerWings.getValue()) {
                this.dragonWingsBiped.render(entityIn, p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, scale, entityPlayer.getWings().getScale(), entityPlayer.getWings().getLocation());
            }
        }

        if (entityIn instanceof AbstractClientPlayer) {
            CheatBreaker.getInstance().getEventBus().handleEvent(new PlayerAnimationEvent(AnimationStage.END, (AbstractClientPlayer) entityIn, this, scale));
