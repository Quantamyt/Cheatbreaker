...
public class ModelBiped extends ModelBase {
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
        ...
        if (p_78088_1_ instanceof AbstractClientPlayer) {
            CheatBreaker.getInstance().getEventBus().handleEvent(new PlayerAnimationEvent(AnimationStage.START, (AbstractClientPlayer)p_78088_1_, this, p_78088_7_));
        }
        if (this.isChild) {
            float var8 = 2.0F;
            GL11.glPushMatrix();
        ...
        if (!this.aimedBow && p_78088_1_ instanceof EntityPlayer && (entityPlayer = (EntityPlayer)p_78088_1_).hasWings()) {
            if (entityPlayer.getWings().getType() == Cosmetic.CosmeticType.WINGS && (Boolean) CheatBreaker.getInstance().getGlobalSettings().showCheatBreakerWings.getValue()) {
                this.dragonWingsBiped.render(p_78088_1_, p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, p_78088_7_, entityPlayer.getWings().getScale(), entityPlayer.getWings().getLocation());
            }
        }

        if (p_78088_1_ instanceof AbstractClientPlayer) {
            CheatBreaker.getInstance().getEventBus().handleEvent(new PlayerAnimationEvent(AnimationStage.END, (AbstractClientPlayer)p_78088_1_, this, p_78088_7_));
