...
public class ModelBiped extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        if (entityIn instanceof AbstractClientPlayer && this instanceof ModelPlayer) {
            CheatBreaker.getInstance().getEventBus().handleEvent(new PlayerAnimationEvent(AnimationStage.START, (AbstractClientPlayer) entityIn, (ModelPlayer) this, scale));
        }
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        switch (this.heldItemRight) {
            ...
            case 3:
                this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleX * 0.5F - ((float) Math.PI / 10F) * (float) this.heldItemRight;
                this.bipedRightArm.rotateAngleY = ModuleOneSevenVisuals.oldSwordBlock3.getBooleanValue() ? 0.0f : -0.5235988F;
        }
        ...
        CosmeticManager cosmeticManager = CheatBreaker.getInstance().getCosmeticManager();
        Emote currentEmote = cosmeticManager.getCurrentEmote();
        if (this.isSneak || (currentEmote != null && currentEmote.getName().equalsIgnoreCase("Naruto Run"))) {
