...
public class ResourcePackRepository {
    ...
    public void updateRepositoryEntriesAll() {
        ...
        while (var2.hasNext()) {
            ...
            if (!this.repositoryEntriesAll.contains(var4)) {
                try {
                    if (PackUtils.isResourcePack(var4.resourcePackFile)) {
    ...
    public class Entry {
        ...
        public String getTexturePackDescription() {
            return this.rePackMetadataSection == null ? EnumChatFormatting.RED +
                    "Invalid pack.mcmeta (or missing 'pack' section)" : this.rePackMetadataSection.func_152805_a().getFormattedText();
        }
