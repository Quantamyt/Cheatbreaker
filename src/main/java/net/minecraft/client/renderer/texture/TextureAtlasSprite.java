...
public class TextureAtlasSprite implements IIcon {
        ...
        if (this.animationMetadata != null) {
            ...
            if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
                ...
                if (var1 != var3 && var3 >= 0 && var3 < this.framesTextureData.size()) {
                    TextureUtil.func_147955_a((int[][])((int[][])this.framesTextureData.get(var3)), this.width, this.height, this.originX, this.originY, texBlur, texClamp);
    ...
    private void loadShadersSprites() {
        ...
        if (Shaders.configNormalMap) {
            ...
            locSpecular = Config.getTextureMap().func_147634_a(locSpecular, 0);
            ...
            if (Config.hasResource(locSpecular)) {
                try {
                    ...
                    e.func_147963_d(this.mipmapLevels);
                    this.spriteNormal = e;
        ...
        if (animationmetadatasection == null) {
            ...
            if (animationmetadatasection.getFrameCount() > 0) {
                ...
                while (list.hasNext()) {
                    ...
                    this.framesTextureData.set(k, func_147962_a(aint, this.width, this.width, k));
                }
                ...
                for (k = 0; k < i; ++k) {
                    this.framesTextureData.add(func_147962_a(aint, this.width, this.width, k));
