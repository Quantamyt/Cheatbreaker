...
//            }
    ...
    public void setColorOpaque(int par1, int par2, int par3) {
        this.setColorRGBA(par1, par2, par3, CheatBreaker.getInstance() != null && CheatBreaker.getInstance().getModuleManager() != null && CheatBreaker.getInstance().getModuleManager().staffModuleXray.isEnabled() ? (Integer) CheatBreaker.getInstance().getModuleManager().staffModuleXray.opacity.getValue() : 255);
    }
