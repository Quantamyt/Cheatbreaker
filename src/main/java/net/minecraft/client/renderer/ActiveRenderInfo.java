...
public class ActiveRenderInfo {
    ...
    public static void updateRenderInfo(EntityPlayer p_74583_0_, boolean p_74583_1_) {
        ...
        float var5 = Minecraft.getMinecraft().currentScreen instanceof GuiContainer ? p_74583_0_.rotationPitch : RenderManager.instance.playerViewX;
        float var6 = Minecraft.getMinecraft().currentScreen instanceof GuiContainer ? p_74583_0_.rotationYaw : RenderManager.instance.playerViewY;
        rotationX = MathHelper.cos(var6 * (float) Math.PI / 180.0F);
        rotationZ = MathHelper.sin(var6 * (float) Math.PI / 180.0F);
        rotationYZ = -rotationZ * MathHelper.sin(var5 * (float)Math.PI / 180.0F);
        rotationXY = rotationX * MathHelper.sin(var5 * (float)Math.PI / 180.0F);
