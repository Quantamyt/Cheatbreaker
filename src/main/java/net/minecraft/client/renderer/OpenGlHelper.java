...
//        return /*Config.isFastRender() ? false : (Config.isAntialiasing() ? false : */framebufferSupported && Minecraft.getMinecraft().gameSettings.fboEnable && CheatBreaker.getInstance().getGlobalSettings().disableFrameBuffers.getBooleanValue()/*)*/;
    }
}
