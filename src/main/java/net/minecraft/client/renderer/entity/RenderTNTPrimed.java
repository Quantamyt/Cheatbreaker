...
public class RenderTNTPrimed extends Render<EntityTNTPrimed>
{
    ...
    {
        if (CheatBreaker.getInstance().getModuleManager().tntTimerMod.isEnabled()) {
            CheatBreaker.getInstance().getModuleManager().tntTimerMod.drawTimer(this, entity, x,y,z, partialTicks);
        }
