...
public class RenderArrow extends Render {
    ...
    public void doRender(EntityArrow p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        if (this.cancelRendering(p_76986_1_)) return;
    ...
    public boolean cancelRendering(EntityArrow entity) {
        final boolean grounded = entity.isInGround();
        final boolean moving = entity.motionX > 0.0 || entity.motionY > 0.0 || entity.motionZ > 0.0;
        return (CheatBreaker.getInstance().getGlobalSettings().hideMovingArrows.getBooleanValue() && moving && !grounded) || (CheatBreaker.getInstance().getGlobalSettings().hideGroundedArrows.getBooleanValue() && grounded);
    }
}
