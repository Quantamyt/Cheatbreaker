...
public class RenderEnderman extends RenderLiving {
     ...
     */
    public void doRender(EntityEnderman par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.endermanModel.isCarrying = par1Entity.func_146080_bZ().getMaterial() != Material.air;
        this.endermanModel.isAttacking = par1Entity.isScreaming();

        if (par1Entity.isScreaming()) {
            double var10 = 0.02D;
     ...
     */
    protected ResourceLocation getEntityTexture(EntityEnderman par1Entity) {
        return endermanTextures;
    }

    protected void renderEquippedItems(EntityEnderman par1EntityLivingBase, float par2) {
        super.renderEquippedItems(par1EntityLivingBase, par2);

        if (par1EntityLivingBase.func_146080_bZ().getMaterial() != Material.air) {
            ...
            int var4 = par1EntityLivingBase.getBrightnessForRender(par2);
            int var5 = var4 % 65536;
            int var6 = var4 / 65536;
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)var5 / 1.0F, (float)var6 / 1.0F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            this.bindTexture(TextureMap.locationBlocksTexture);
            this.field_147909_c.renderBlockAsItem(par1EntityLivingBase.func_146080_bZ(), par1EntityLivingBase.getCarryingData(), 1.0F);
            GL11.glPopMatrix();
     ...
     */
    protected int shouldRenderPass(EntityEnderman par1EntityLivingBase, int par2, float par3) {
        if (par2 != 0) {
            return -1;
        } else {
