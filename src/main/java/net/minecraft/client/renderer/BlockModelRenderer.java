...
public class BlockModelRenderer
{
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        if (!Objects.equals(string, "NO") && (blockStateIn.getBlock() instanceof BlockGlass ? string.equals("REGULAR") || string.equals("ALL") : blockStateIn.getBlock() instanceof BlockStainedGlass && string.equals("ALL"))) {
            return false;
        }
        ...
        if (foiliageEnabled) {
            if (
                    blockStateIn.getBlock() instanceof BlockTallGrass
                    || blockStateIn.getBlock() instanceof BlockDeadBush
                    || blockStateIn.getBlock() instanceof BlockBush
            )
            {
                return false;
            }
    ...
    private void renderQuadsSmooth(IBlockAccess p_renderQuadsSmooth_1_, IBlockState p_renderQuadsSmooth_2_, BlockPos p_renderQuadsSmooth_3_, WorldRenderer p_renderQuadsSmooth_4_, List<BakedQuad> p_renderQuadsSmooth_5_, RenderEnv p_renderQuadsSmooth_6_)
    {
        ...
        EnumOffsetType enumoffsettype = block.getOffsetType();
        ...
        if (enumoffsettype != EnumOffsetType.NONE)
        {
            ...
            if (enumoffsettype == EnumOffsetType.XYZ)
            {
