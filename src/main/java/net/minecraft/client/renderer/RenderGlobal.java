...
public class RenderGlobal implements IWorldAccess {
    ...
    public void loadRenderers() {
        if (this.theWorld != null) {
            ...
            if (this.theWorld != null) {
                EntityLivingBase var13 = this.mc.renderViewEntity;
                ...
                if (var13 != null) {
                    this.markRenderersForNewPosition(MathHelper.floor_double(var13.posX), MathHelper.floor_double(var13.posY), MathHelper.floor_double(var13.posZ));
                    EntitySorterFast var15 = new EntitySorterFast(var13);
    ...
    public void renderEntities(EntityLivingBase p_147589_1_, ICamera p_147589_2_, float p_147589_3_) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (pass == 0) {
                ...
                double var111 = var17.lastTickPosY + (var17.posY - var17.lastTickPosY) * (double)p_147589_3_;
                ...
                TileEntityRendererDispatcher.staticPlayerY = var111;
            ...
            for (var26 = 0; var26 < this.theWorld.weatherEffects.size(); ++var26) {
                var19 = (Entity)this.theWorld.weatherEffects.get(var26);
            ...
            for (var26 = 0; var26 < var25.size(); ++var26) {
                var19 = (Entity)var25.get(var26);

                if (!hasEntityShouldRenderInPass || Reflector.callBoolean(var19, Reflector.ForgeEntity_shouldRenderInPass, new Object[] {Integer.valueOf(pass)})) {
                    boolean var28 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || p_147589_2_.isBoundingBoxInFrustum(var19.boundingBox) || var19.riddenByEntity == this.mc.thePlayer);

                    if (!var28 && var19 instanceof EntityLiving) {
                    ...
                    if (var28 && (var19 != this.mc.renderViewEntity || this.mc.gameSettings.thirdPersonView != 0 || this.mc.renderViewEntity.isPlayerSleeping()) && this.theWorld.blockExists(MathHelper.floor_double(var19.posX), 0, MathHelper.floor_double(var19.posZ))) {
                        ++this.countEntitiesRendered;
            ...
            for (var26 = 0; var26 < this.tileEntities.size(); ++var26) {
                TileEntity var29 = (TileEntity)this.tileEntities.get(var26);
                    ...
                    if (var30 == AABB_INFINITE || p_147589_2_.isBoundingBoxInFrustum(var30)) {
                        ...
                        if (var31 == TileEntitySign.class && !Config.zoomMode) {
                            ...
                            if (distSq > 256.0D) {
                                ...
                                TileEntityRendererDispatcher.instance.func_147544_a(var29, p_147589_3_);
                        ...
                        if (var31 == TileEntityChest.class) {
                            Block var32 = this.theWorld.getBlock(var29.field_145851_c, var29.field_145848_d, var29.field_145849_e);
    ...
    public void renderSky(float par1) {
        ...
        if (this.mc.theWorld.provider.dimensionId == 1) {
            ...
            CustomSky.renderSky(this.theWorld, this.renderEngine, par1);
            ...
            boolean showBottomSkyLayer = CheatBreaker.getInstance().getGlobalSettings().bottomSkyLayer.getValue().equals("No Custom Sky") ? !Config.isCustomSky() || CustomSky.getWorldSkyLayers() == null : CheatBreaker.getInstance().getGlobalSettings().bottomSkyLayer.getValue().equals("ON");
            if (Config.isSkyEnabled() && showBottomSkyLayer) {
                GL11.glCallList(this.glSkyList2);
            }
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                        ...
                        float var24 = (float)(cdx * (double)var10);
                ...
                if (var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
                    ...
                    if (par1Str.equals("bubble")) {
                        ...
                        if (Config.isPotionParticles()) {
                            if (!CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.activeEffectParticles.getValue()) {
                                var21 = new EntitySpellParticleFX(this.theWorld, par2, par4, par6, 0.0D, 0.0D, 0.0D);
                                if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled()) {
                                    var21.setAlphaF((float) CheatBreaker.getInstance().getModuleManager().particlesMod.activeEffectOpacity.getValue() / 100.0F);
                                }
                        ...
                        if (Config.isPotionParticles()) {
                            if (!CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.activeEffectParticles.getValue()) {
                                var21 = new EntitySpellParticleFX(this.theWorld, par2, par4, par6, 0.0D, 0.0D, 0.0D);
                                if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled()) {
                                    var21.setAlphaF((float) CheatBreaker.getInstance().getModuleManager().particlesMod.activeEffectAmbientOpacity.getValue() / 100.0F);
                                } else {
                        ...
                        if (Config.isPotionParticles()) {
                            if (!CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.splashParticles.getValue()) {
                                var21 = new EntitySpellParticleFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                                if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled()) {
                                    var21.setAlphaF((float) CheatBreaker.getInstance().getModuleManager().particlesMod.normalEffectSplashOpacity.getValue() / 100.0F);
                                }
                            }
                        }
                        ...
                        if (Config.isPotionParticles()) {
                            if (!CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().particlesMod.splashParticles.getValue()) {
                                var21 = new EntitySpellParticleFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                                if (CheatBreaker.getInstance().getModuleManager().particlesMod.isEnabled()) {
                                    var21.setAlphaF((float) CheatBreaker.getInstance().getModuleManager().particlesMod.instantEffectSplashOpacity.getValue() / 100.0F);
                                }
