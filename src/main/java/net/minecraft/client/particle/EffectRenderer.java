...
import com.cheatbreaker.client.module.impl.normal.vanilla.ModuleParticles;
...
public class EffectRenderer
{
    ...
    public void emitParticleAtEntity(Entity entityIn, EnumParticleTypes particleTypes, float multiplier)
    {
        this.particleEmitters.add(new EntityParticleEmitter(this.worldObj, entityIn, particleTypes, multiplier));
    }
    ...
    {
        ModuleParticles mod = CheatBreaker.getInstance().getModuleManager().particlesMod;
        if (mod.isEnabled() && !mod.blockBreakingParticles.getBooleanValue()) {
            return;
        }
