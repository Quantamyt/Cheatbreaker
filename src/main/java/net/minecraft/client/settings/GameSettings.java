...
public class GameSettings {
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value) {
        ...
        if (settingsOption == GameSettings.Options.ENTITY_SHADOWS) {
            ...
            CheatBreaker.getInstance().getGlobalSettings().entityShadows.setValue(this.entityShadows);
        }
                ...
                if (this.optionsFile.exists()) {
                    ...
                    while ((s = bufferedreader.readLine()) != null) {
                        try {
                            ...
                            if (astring[0].equalsIgnoreCase("oldGamma")) {
                                this.oldGammaSetting = this.parseFloat(astring[1]);
                            }
    ...
    public void saveOptions() {
        ...
        try {
            ...
            if (!CheatBreaker.getInstance().getGlobalSettings().fullBright.getBooleanValue()) {
                printwriter.println("oldGamma:" + this.oldGammaSetting);
            }
