...
public class GuiAchievement extends Gui {
    ...
    public void func_146254_a() {
        if (this.field_146266_k != null && this.field_146263_l != 0L && Minecraft.getMinecraft().thePlayer != null && (Boolean) CheatBreaker.getInstance().getGlobalSettings().achievements.getValue()) {
