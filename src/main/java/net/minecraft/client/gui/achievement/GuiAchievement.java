...
public class GuiAchievement extends Gui
{
    ...
    {
        if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null && CheatBreaker.getInstance().getGlobalSettings().achievements.getBooleanValue())
        {
