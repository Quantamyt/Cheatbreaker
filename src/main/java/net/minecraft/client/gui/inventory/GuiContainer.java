...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        if (!CheatBreaker.getInstance().getModuleManager().packTweaksMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().packTweaksMod.tooltips.getValue()) {
    ...
    protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_) {
        CheatBreaker.getInstance().getEventBus().handleEvent(new ClickEvent(p_146286_3_));
