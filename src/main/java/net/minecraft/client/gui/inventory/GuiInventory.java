...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (!(Boolean) CheatBreaker.getInstance().getModuleManager().packTweaksMod.transparentInventory.getValue()
            || !CheatBreaker.getInstance().getModuleManager().packTweaksMod.isEnabled()) {
