...
public class GuiRepair extends GuiContainer implements ICrafting {
    ...
    protected void keyTyped(char p_73869_1_, int p_73869_2_) {
        if (this.field_147091_w.keyTyped(p_73869_1_, p_73869_2_)) {
            this.func_147090_g();
        } else {
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        drawTexturedModalRect(var4 + 59, var5 + 20, 0, this.field_147000_g + (this.field_147092_v.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
        ...
        if ((this.field_147092_v.getSlot(0).getHasStack() || this.field_147092_v.getSlot(1).getHasStack()) && !this.field_147092_v.getSlot(2).getHasStack()) {
            drawTexturedModalRect(var4 + 99, var5 + 45, this.field_146999_f, 0, 28, 21);
        }
    }
