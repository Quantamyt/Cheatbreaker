    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (var6 != null && !var6.isEmpty()) {
            ...
            if (var8.isRecipeDisabled()) {
                ...
                drawTexturedModalRect(this.field_147003_i + 83, this.field_147009_r + 21, 212, 0, 28, 21);
                drawTexturedModalRect(this.field_147003_i + 83, this.field_147009_r + 51, 212, 0, 28, 21);
            }
        }
    }
    ...
    static class MerchantButton extends GuiButton {
        ...
        public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
            if (this.field_146125_m) {
                ...
                drawTexturedModalRect(this.field_146128_h, this.field_146129_i, var6, var5, this.field_146120_f, this.field_146121_g);
            }
        }
    }
}
