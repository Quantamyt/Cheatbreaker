...
public class MapItemRenderer {
    ...
    class Instance {
        ...
        private void func_148237_a(boolean p_148237_1_) {
            ...
            var4.addVertexWithUV((float)(var2 + 0) + var5, (float)(var3 + 128) - var5, -0.009999999776482582D, 0.0D, 1.0D);
            var4.addVertexWithUV((float)(var2 + 128) - var5, (float)(var3 + 128) - var5, -0.009999999776482582D, 1.0D, 1.0D);
            var4.addVertexWithUV((float)(var2 + 128) - var5, (float)(var3 + 0) + var5, -0.009999999776482582D, 1.0D, 0.0D);
            var4.addVertexWithUV((float)(var2 + 0) + var5, (float)(var3 + 0) + var5, -0.009999999776482582D, 0.0D, 0.0D);
            var4.draw();
