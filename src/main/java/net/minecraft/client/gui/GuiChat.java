...
public class GuiChat extends GuiScreen implements GuiYesNoCallback {
    ...
    protected void keyTyped(char p_73869_1_, int p_73869_2_) {
        ...
        if (p_73869_2_ == 1) {
            ...
            if (p_73869_2_ == 200) {
                ...
                this.field_146415_a.keyTyped(p_73869_1_, p_73869_2_);
            }
        } else {
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int mouseButton) {
            ...
            if (var4 != null) {
                ...
                if (var5 != null) {
                    if (isShiftKeyDown()) {
                        ...
                        } else if (var5.getAction() == ClickEvent.Action.UPLOAD_SCREENSHOT) {
                            this.sendUpdateServer(var5.getValue());
                        } else if (var5.getAction() == ClickEvent.Action.COPY_SCREENSHOT) {
                            ScreenShotHelper.IllIlIIIllllIIllIIlllIIlI(var5.getValue());
                        } else {
        ...
        this.field_146415_a.mouseClicked(p_73864_1_, p_73864_2_, mouseButton);
        ...
        if (var2.exists()) {
            ...
            new Thread(() -> {
                try {
                    ...
                    this.field_146411_u = new URI(var13);
...
//                    CheatBreaker.getInstance().getModuleManager().notificationsMod.send("Error", "&fScreenshot upload &cfailed!", 3000L);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        if (!CheatBreaker.getInstance().getModuleManager().chatMod.isEnabled() || (Boolean) CheatBreaker.getInstance().getModuleManager().chatMod.inputFieldBackground.getValue()) {
            drawRect(2, this.height - 14, this.width - 2, this.height - 2, CheatBreaker.getInstance().getModuleManager().chatMod.backgroundColor.getColorValue());
        }
