...
public abstract class World implements IBlockAccess {
        ...
        if (!Double.isNaN(p_147447_1_.xCoord) && !Double.isNaN(p_147447_1_.yCoord) && !Double.isNaN(p_147447_1_.zCoord)) {
            if (!Double.isNaN(p_147447_2_.xCoord) && !Double.isNaN(p_147447_2_.yCoord) && !Double.isNaN(p_147447_2_.zCoord)) {
                ...
                while (var13-- >= 0) {
                    ...
                    var9 = (int)(var36.xCoord = MathHelper.floor_double(p_147447_1_.xCoord));
                    ...
                    var10 = (int)(var36.yCoord = MathHelper.floor_double(p_147447_1_.yCoord));
                    ...
                    var11 = (int)(var36.zCoord = MathHelper.floor_double(p_147447_1_.zCoord));
                ...
                for (int var13 = var6; var13 < var7; ++var13) {
                    for (int var14 = var8; var14 < var9; ++var14) {
                        ...
                        if (var15.getMaterial() == p_72918_2_) {
                            double var16 = (float)(var13 + 1) - BlockLiquid.func_149801_b(this.getBlockMetadata(var12, var13, var14));
    ...
    public boolean func_147478_e(int p_147478_1_, int p_147478_2_, int p_147478_3_, boolean p_147478_4_) {
        ...
        if (var6 > 0.15F) {
            ...
            if (p_147478_2_ >= 0 && p_147478_2_ < 256 && this.getSavedLightValue(EnumSkyBlock.Block, p_147478_1_, p_147478_2_, p_147478_3_) < 10) {
                ...
                return var7.getMaterial() == Material.air && Blocks.snow_layer.canPlaceBlockAt(this, p_147478_1_, p_147478_2_, p_147478_3_);
            }
    ...
    public EntityPlayer getPlayerEntityByName(String p_72924_1_) {
        for (int var2 = 0; var2 < this.playerEntities.size(); ++var2) {
            EntityPlayer var3 = this.playerEntities.get(var2);
    ...
    public EntityPlayer isPlayerTeamMate(String string) {
        for (int i = 0; i < this.playerEntities.size(); ++i) {
            EntityPlayer entityPlayer = this.playerEntities.get(i);
            if (!entityPlayer.isEntityAlive() || !string.equals(entityPlayer.getGameProfile().getId().toString()) && !string.equals(entityPlayer.getGameProfile().getId().toString().replaceAll("-", ""))) continue;
            return entityPlayer;
        }
        return null;
    }
