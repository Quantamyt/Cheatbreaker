...
public class TileEntityBeacon extends TileEntity implements IInventory {
    ...
    private void func_146000_x() {
        if (this.field_146015_k && this.field_146012_l > 0 && !this.worldObj.isClient && this.field_146013_m > 0) {
            ...
            AxisAlignedBB var4 = AxisAlignedBB.getBoundingBox(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.field_145851_c + 1, this.field_145848_d + 1, this.field_145849_e + 1).expand(var1, var1, var1);
    ...
    private void func_146003_y() {
        ...
        if (!this.worldObj.isClient && this.field_146012_l == 4 && var1 < this.field_146012_l) {
            Iterator var8 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.field_145851_c, this.field_145848_d - 4, this.field_145849_e).expand(10.0D, 5.0D, 10.0D)).iterator();
