            ...
            if (p_71515_2_.length > 0 && p_71515_2_[0].length() > 1) {
                if ("hottest-read".equals(p_71515_2_[0])) {
                    ...
                    if ("packet-read".equals(p_71515_2_[0])) {
                        ...
                        p_71515_1_.addChatMessage(new ChatComponentText("total-read-count" + NetworkManager.field_152462_h.func_152472_c()));
                    } else if ("write-count".equals(p_71515_2_[0])) {
                        p_71515_1_.addChatMessage(new ChatComponentText("total-write-count" + NetworkManager.field_152462_h.func_152473_d()));
                    } else {
