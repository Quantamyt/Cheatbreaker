...
public class Block {
    ...
    public static IIcon renderBlockIcon;
    ...
    public int getLightValue() {
        return CheatBreaker.getInstance().getModuleManager().staffModuleXray.shouldRender(Block.getIdFromBlock(this), true) ? this.lightValue : 15;
    }
    ...
    public void addCollisionBoxesToList(World var1, int var2, int var3, int var4, AxisAlignedBB var5, List var6, Entity var7) {
        ...
        CollisionEvent var9 = new CollisionEvent(var6, var2, var3, var4);
        CheatBreaker.getInstance().getEventBus().handleEvent(var9);
        if (!var9.isCanceled() && var8 != null && var5.intersectsWith(var8)) {
            var6.add(var8);
        }
    }
    ...
    public int getRenderBlockPass() {
        return CheatBreaker.getInstance().getModuleManager().staffModuleXray.shouldRender(Block.getIdFromBlock(this), true) ? 0 : 1;
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        if (Objects.equals(this.textureName, "trip_wire")) {
            renderBlockIcon = p_149651_1_.registerIcon("trip_wire_full");
        }
