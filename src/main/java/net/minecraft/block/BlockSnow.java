...
public class BlockSnow extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_, int p_149668_4_) {
        ...
        float var6 = 0.125F;
        return AxisAlignedBB.getBoundingBox((double)p_149668_2_ + this.field_149759_B, (double)p_149668_3_ + this.field_149760_C, (double)p_149668_4_ + this.field_149754_D, (double)p_149668_2_ + this.field_149755_E, (float)p_149668_3_ + (float)var5 * var6, (double)p_149668_4_ + this.field_149757_G);
    }
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
        ...
        return var5 != Blocks.ice && var5 != Blocks.packed_ice && (var5.getMaterial() == Material.leaves || (var5 == this && (p_149742_1_.getBlockMetadata(p_149742_2_, p_149742_3_ - 1, p_149742_4_) & 7) == 7 || var5.isOpaqueCube() && var5.blockMaterial.blocksMovement()));
    }
