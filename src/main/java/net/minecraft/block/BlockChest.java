...
public class BlockChest extends BlockContainer {
            ...
            for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8) {
                ...
                if (var9 != null) {
                    ...
                    for (float var12 = this.field_149955_b.nextFloat() * 0.8F + 0.1F; var9.stackSize > 0; p_149749_1_.spawnEntityInWorld(var14)) {
                        ...
                        var14 = new EntityItem(p_149749_1_, (float)p_149749_2_ + var10, (float)p_149749_3_ + var11, (float)p_149749_4_ + var12, new ItemStack(var9.getItem(), var13, var9.getItemDamage()));
                        float var15 = 0.05F;
    ...
    private static boolean func_149953_o(World p_149953_0_, int p_149953_1_, int p_149953_2_, int p_149953_3_) {
        Iterator var4 = p_149953_0_.getEntitiesWithinAABB(EntityOcelot.class, AxisAlignedBB.getBoundingBox(p_149953_1_, p_149953_2_ + 1, p_149953_3_, p_149953_1_ + 1, p_149953_2_ + 2, p_149953_3_ + 1)).iterator();
        EntityOcelot var6;
