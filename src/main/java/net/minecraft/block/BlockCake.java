...
public class BlockCake extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_, int p_149668_4_) {
        ...
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.5F;
        return AxisAlignedBB.getBoundingBox((float)p_149668_2_ + var7, p_149668_3_, (float)p_149668_4_ + var6, (float)(p_149668_2_ + 1) - var6, (float)p_149668_3_ + var8 - var6, (float)(p_149668_4_ + 1) - var6);
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_, int p_149633_2_, int p_149633_3_, int p_149633_4_) {
        ...
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.5F;
        return AxisAlignedBB.getBoundingBox((float)p_149633_2_ + var7, p_149633_3_, (float)p_149633_4_ + var6, (float)(p_149633_2_ + 1) - var6, (float)p_149633_3_ + var8, (float)(p_149633_4_ + 1) - var6);
    }
