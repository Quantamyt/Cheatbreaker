...
import com.cheatbreaker.client.event.impl.RenderWorldEvent;
                ...
                if (entityClientPlayerMP.posX >= worldBorder.getStartingMaxX() - d ||
                    ...
                    if (d5 > worldBorder.getStartingMaxX() - d) {
                        ...
                        while (d3 < d9) {
                            ...
                            tessellator.addVertexWithUV(worldBorder.getStartingMaxX(), 256, d3, f7 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(worldBorder.getStartingMaxX(), 256, d3 + d2, f7 + f2 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(worldBorder.getStartingMaxX(), 0.0, d3 + d2, f7 + f2 + f3, f7 + (float)128);
                            tessellator.addVertexWithUV(worldBorder.getStartingMaxX(), 0.0, d3, f7 + f3, f7 + (float)128);
                            d3 += 1.0;
                    ...
                    if (d5 < worldBorder.getStartingMinX() + d) {
                        ...
                        while (d3 < d9) {
                            ...
                            tessellator.addVertexWithUV(worldBorder.getStartingMinX(), 256, d3, f7 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(worldBorder.getStartingMinX(), 256, d3 + d2, f7 + f2 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(worldBorder.getStartingMinX(), 0.0, d3 + d2, f7 + f2 + f3, f7 + (float)128);
                            tessellator.addVertexWithUV(worldBorder.getStartingMinX(), 0.0, d3, f7 + f3, f7 + (float)128);
                            d3 += 1.0;
                            f3 += 1.25f * 0.4f;
                        }
                    }
                    ...
                    if (d7 > worldBorder.getStartingMaxZ() - d) {
                        ...
                        while (d3 < d9) {
                            ...
                            tessellator.addVertexWithUV(d3, 256, worldBorder.getStartingMaxZ(), f7 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(d3 + d2, 256, worldBorder.getStartingMaxZ(), f7 + f2 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(d3 + d2, 0.0, worldBorder.getStartingMaxZ(), f7 + f2 + f3, f7 + (float)128);
                            tessellator.addVertexWithUV(d3, 0.0, worldBorder.getStartingMaxZ(), f7 + f3, f7 + (float)128);
                            d3 += 1.0;
                    ...
                    if (d7 < worldBorder.getStartingMinZ() + d) {
                        ...
                        while (d3 < d9) {
                            ...
                            tessellator.addVertexWithUV(d3, 256, worldBorder.getStartingMinZ(), f7 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(d3 + d2, 256, worldBorder.getStartingMinZ(), f7 + f2 + f3, f7 + 0.0f);
                            tessellator.addVertexWithUV(d3 + d2, 0.0, worldBorder.getStartingMinZ(), f7 + f2 + f3, f7 + (float)128);
                            tessellator.addVertexWithUV(d3, 0.0, worldBorder.getStartingMinZ(), f7 + f3, f7 + (float)128);
                            d3 += 1.0;
