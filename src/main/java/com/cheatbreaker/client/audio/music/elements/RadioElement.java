...
public class RadioElement extends DraggableElement {
    ...
    public boolean isMouseIn(float var1, float var2) {
        return var1 > this.xPosition && var1 < this.xPosition + this.width && var2 > this.yPosition && var2 < this.yPosition + this.newHeight;
    }
        ...
        if (currentStation != null) {
            if (currentStation.currentResource == null && !currentStation.getCoverURL().equals("")) {
                if (currentStation.previousResource != null) {
                    this.mc.getTextureManager().func_147645_c(currentStation.previousResource);
