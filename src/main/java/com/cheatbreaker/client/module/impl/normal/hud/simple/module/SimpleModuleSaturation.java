...
import com.cheatbreaker.client.module.impl.normal.hud.simple.SimpleHudModSize;
...
/**
 * @Module - ModuleSaturation
 * @see AbstractSimpleHudModule
 *
 * This module shows the current Saturation level of the player.
 */
public class SimpleModuleSaturation extends AbstractSimpleHudModule {
    ...
    private Setting hideExceedingNumbers;
    private Setting exceedingThreshold;
    private Setting trailingZeros;
    private Setting decimals;

    public SimpleModuleSaturation() {
        super("Saturation");
    ...
    public String getValueString() {
        ...
        boolean exceedingCheck = !(Boolean) hideExceedingNumbers.getValue() || mc.thePlayer.getFoodStats().getSaturationLevel() < (Integer) exceedingThreshold.getValue();
        if (creativeModeCheck && exceedingCheck) {
            return level();
        }
        return null;
    }
    ...
    public void getExtraSettings() {
        ...
        this.hideExceedingNumbers = new Setting(this, "Hide exceeding levels", "Hide the mod when the current saturation level exceeds the set amount.").setValue(false).setCustomizationLevel(CustomizationLevel.MEDIUM);
        this.exceedingThreshold = new Setting(this, "Exceeding amount", "Determine the maximum value of saturation levels should show before it is hidden.").setValue(20).setMinMax(0, 20).setUnit(" levels").setCustomizationLevel(CustomizationLevel.MEDIUM).setCondition(() -> (Boolean) this.hideExceedingNumbers.getValue());
