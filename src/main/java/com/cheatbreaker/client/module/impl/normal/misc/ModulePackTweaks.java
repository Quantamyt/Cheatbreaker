...
public class ModulePackTweaks extends AbstractModule {
    ...
    public Setting lowHealthOverlay;
    public Setting lowHealthStart;
    public Setting lowHealthOverlayOpacity;
    ...
    public ModulePackTweaks() {
        ...
        this.coloredString = new Setting(this, "Colored String", "Show a solid color line instead of the texture pack's string texture.").setValue(false).setCondition(() -> Config.MC_VERSION.equals("1.7.10")).onChange(value -> this.mc.renderGlobal.loadRenderers()).setCustomizationLevel(CustomizationLevel.SIMPLE);
        this.coloredStringColor = new Setting(this, "Colored String Color").setValue(0xFFFF0000).setMinMax(Integer.MIN_VALUE, Integer.MAX_VALUE).setCustomizationLevel(CustomizationLevel.SIMPLE).setCondition(() -> (Boolean) this.coloredString.getValue() && Config.MC_VERSION.equals("1.7.10"));
        ...
        new Setting(this, "label").setValue("Low Health Options").setCustomizationLevel(CustomizationLevel.MEDIUM);
        this.lowHealthOverlay = new Setting(this, "Low Health Overlay").setValue(false).setCustomizationLevel(CustomizationLevel.MEDIUM);
        this.lowHealthStart = new Setting(this, "Low Health Start").setValue(3.5F).setMinMax(1.0F, 10.0F).setUnit(" hearts").setCustomizationLevel(CustomizationLevel.MEDIUM).setCondition(() -> this.lowHealthOverlay.getBooleanValue());
        this.lowHealthOverlayOpacity = new Setting(this, "Low Health Opacity").setValue(75.0f).setMinMax(0.0f, 100.0f).setUnit("%").setCustomizationLevel(CustomizationLevel.MEDIUM).setCondition(() -> this.lowHealthOverlay.getBooleanValue());
