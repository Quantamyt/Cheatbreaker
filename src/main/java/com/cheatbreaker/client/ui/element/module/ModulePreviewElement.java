...
public class ModulePreviewElement extends AbstractModulesGuiElement {
    ...
    public void handleDrawElement(int mouseX, int n2, float partialTicks) {
        ...
        if (this.module.isEnabled()) {
            RenderUtil.drawRoundedRect(this.x, this.y, this.x + this.width, this.compact ? this.y + 16 : this.y + this.height, 3,
                    GlobalSettings.darkMode.getBooleanValue() ? CBTheme.darkEnabledBackgroundColor : CBTheme.lightEnabledBackgroundColor);
        } else {
            RenderUtil.drawRoundedRect(this.x, this.y, this.x + this.width, this.compact ? this.y + 16 : this.y + this.height, 3,
                    GlobalSettings.darkMode.getBooleanValue() ? CBTheme.darkInactiveBackgroundColor : CBTheme.lightInactiveBackgroundColor);
        }
        ...
        if (!this.compact) {
            if (this.module == CheatBreaker.getInstance().getModuleManager().armourStatus) {
                ...
                f2 = Minecraft.getMinecraft().fontRendererObj.getStringWidth(previewString);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(previewString, (float) ((int) ((float) (this.x + 1 + this.width / 2) - f2 / 2.0f)), (float) (this.y + this.height / 2 - 18), -1);
            } else if (this.module == CheatBreaker.getInstance().getModuleManager().potionEffectsMod) {
                n4 = -30;
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Speed II", (float) (this.x + 8 + this.width / 2 - 20), (float) (this.y + this.height / 2 - 36), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("0:42", (float) (this.x + 8 + this.width / 2 - 20), (float) (this.y + this.height / 2 - 26), -1);
                ...
                Minecraft.getMinecraft().fontRendererObj.drawCenteredStringWithShadow("Score", this.x + this.width / 2, this.y + this.height / 2 - 40, -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Steve", (float) (this.x + 24), (float) (this.y + this.height / 2 - 28), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Alex", (float) (this.x + 24), (float) (this.y + this.height / 2 - 18), -1);
                Minecraft.getMinecraft().fontRendererObj.drawCenteredStringWithShadow(EnumChatFormatting.RED + "0", this.x + this.width - 26, this.y + this.height / 2 - 18, -1);
                Minecraft.getMinecraft().fontRendererObj.drawCenteredStringWithShadow(EnumChatFormatting.RED + "1", this.x + this.width - 26, this.y + this.height / 2 - 28, -1);
            } else if (this.module == CheatBreaker.getInstance().getModuleManager().bossBarMod) {
                n3 = 3;
                previewString = "Wither";
                f2 = Minecraft.getMinecraft().fontRendererObj.getStringWidth(previewString);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(previewString, (float) ((int) ((float) (this.x + 1 + this.width / 2) - f2 / 2.0f)), (float) (this.y + this.height / 2 - 36), -1);
                ...
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(Minecraft.getMinecraft().getSession().getUsername(), (float) (this.x + 21), (float) (this.y + this.height / 2 - 43), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Steve", (float) (this.x + 21), (float) (this.y + this.height / 2 - 34), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Alex", (float) (this.x + 21), (float) (this.y + this.height / 2 - 25), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Notch", (float) (this.x + 21), (float) (this.y + this.height / 2 - 16), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.GREEN + "15", (float) (this.x + this.width - 21 - Minecraft.getMinecraft().fontRendererObj.getStringWidth("15")), (float) (this.y + this.height / 2 - 43), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.GREEN + "75", (float) (this.x + this.width - 21 - Minecraft.getMinecraft().fontRendererObj.getStringWidth("75")), (float) (this.y + this.height / 2 - 34), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.YELLOW + "155", (float) (this.x + this.width - 21 - Minecraft.getMinecraft().fontRendererObj.getStringWidth("155")), (float) (this.y + this.height / 2 - 25), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.YELLOW + "250", (float) (this.x + this.width - 21 - Minecraft.getMinecraft().fontRendererObj.getStringWidth("250")), (float) (this.y + this.height / 2 - 16), -1);
                ...
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.GREEN + "Steve" + EnumChatFormatting.WHITE + ": Hey.", (float) (this.x + 10), (float) (this.y + this.height / 2 - 34), -1);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(EnumChatFormatting.GREEN + "Alex" + EnumChatFormatting.WHITE + ": Hi!", (float) (this.x + 10), (float) (this.y + this.height / 2 - 25), -1);
            } else if (this.module == CheatBreaker.getInstance().getModuleManager().nameTagMod) {
                int width = Minecraft.getMinecraft().fontRendererObj.getStringWidth(Minecraft.getMinecraft().getSession().getUsername());
                String account = width > 94 ? "Steve" : Minecraft.getMinecraft().getSession().getUsername();
                width = Minecraft.getMinecraft().fontRendererObj.getStringWidth(account);
                ...
                Minecraft.getMinecraft().fontRendererObj.drawString(account, this.x + this.width / 2 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(account) / 2 + 7, this.y + this.height / 2 - 32, -1, false);
            ...
            if (this.module == CheatBreaker.getInstance().getModuleManager().coolDownsMod) {
                ...
                float f3 = (float) Minecraft.getMinecraft().fontRendererObj.getStringWidth(previewString) * f2;
                if (this.module.getPreviewType() == null && !this.compact) {
                    Minecraft.getMinecraft().fontRendererObj.drawString(previewString, (int) (((float) (this.x + 1 + this.width / 2) - f3 / 2.0f) / f2), (int) ((float) (this.y + this.height / 2 - 32) / f2), -13750738);
                } else {
                    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(previewString, (float) ((int) (((float) (this.x + 1 + this.width / 2) - f3 / 2.0f) / f2)), (float) ((int) ((float) (this.y + this.height / 2 - 32) / f2)), -1);
                }
