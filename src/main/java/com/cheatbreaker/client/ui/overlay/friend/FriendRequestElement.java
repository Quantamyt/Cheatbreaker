...
public class FriendRequestElement extends AbstractElement {
    ...
    public void handleElementDraw(float f, float f2, boolean bl) {
        ...
        ResourceLocation resourceLocation = CheatBreaker.getInstance().getHeadIcon(EnumChatFormatting.getTextWithoutFormattingCodes(this.friendRequest.getUsername()));
