...
public class ProfileCreatorGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (!this.showGui) {
            ...
            this.showGui = false;
            this.textField = new GuiTextField(this.mc.fontRenderer, this.width / 2 - 70, this.height / 2 - 6, 140, 10);
        ...
        switch (n) {
            ...
            case 28:
                ...
                if (this.profile != null && !this.profile.isNotEditable()) {
                    File file = new File(Minecraft.getMinecraft().mcDataDir + File.separator + "config" + File.separator + "cheatbreaker-client-" + Config.MC_VERSION + "-" + CheatBreaker.getInstance().getGitBranch() + File.separator + "profiles" + File.separator + this.profile.getName() + ".cfg");
                    File file2 = new File(Minecraft.getMinecraft().mcDataDir + File.separator + "config" + File.separator + "cheatbreaker-client-" + Config.MC_VERSION + "-" + CheatBreaker.getInstance().getGitBranch() + File.separator + "profiles" + File.separator + this.textField.getText() + ".cfg");
                ...
                if (profile == null) {
                    ...
                    CheatBreaker.getInstance().profiles.add(profile3);
                    CheatBreaker.getInstance().activeProfile = profile3;
