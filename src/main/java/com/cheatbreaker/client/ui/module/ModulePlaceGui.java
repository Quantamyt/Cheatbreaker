...
//        }
        ...
        if (!Mouse.isButtonDown(1)) {
            ...
            f4 = this.lIIIIlIIllIIlIIlIIIlIIllI(this.module, f4, arrf3, (float)((int)(this.module.width * (Float) this.module.masterScale())), false);
            f5 = this.lIIIIIIIIIlIllIIllIlIIlIl(this.module, f5, arrf3, (float)((int)(this.module.height * (Float) this.module.masterScale())), false);
        }
    ...
    private float lIIIIlIIllIIlIIlIIIlIIllI(AbstractModule abstractModule, float f, float[] arrf, float f2, boolean bl) {
        ...
        if (f3 + arrf[0] < (float)n) {
            f3 = -arrf[0] + (float)n;
        } else if (f3 + arrf[0] * (Float) abstractModule.masterScale() + f2 > (float)(this.width - n)) {
            f3 = (int)((float)this.width - arrf[0] * (Float) abstractModule.masterScale() - f2 - (float)n);
        }
        return f3;
    }
    ...
    private float lIIIIIIIIIlIllIIllIlIIlIl(AbstractModule abstractModule, float f, float[] arrf, float f2, boolean bl) {
        ...
        if (f3 + arrf[1] < (float)n) {
            f3 = -arrf[1] + (float)n;
        } else if (f3 + arrf[1] * (Float) abstractModule.masterScale() + f2 > (float)(this.height - n)) {
            f3 = (int)((float)this.height - arrf[1] * (Float) abstractModule.masterScale() - f2 - (float)n);
        }
        return f3;
    }
