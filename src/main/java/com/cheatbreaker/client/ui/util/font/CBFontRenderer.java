...
public class CBFontRenderer extends CBFont {
    ...
    public float drawCenteredStringWithShadow(String var1, double var2, double var4, int var6, int var7) {
        float shadowWidth = this.drawString(var1, var2 + 1.0, var4 + 1.0, var7, false);
    ...
    public String formatText(String var1, double var2) {
        ...
        for (char var10 : var1.toCharArray()) {
            ...
            String var15 = EnumChatFormatting.formatColor(var4.toString());
            var4.setLength(0);
