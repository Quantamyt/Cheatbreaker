...
public class AccountList extends AbstractElement {
    ...
    public void setElementSize(float f, float y, float width, float height) {
        ...
        this.accountSelectionBoxHeight = Math.min(this.mainMenuBase.getAccounts().size() * 16 + 12, 120);
    ...
    protected void handleElementDraw(float f, float f2, boolean bl) {
        ...
        if (this.interacting) {
            ...
            int n = 1;
            for (CBAccount account : this.mainMenuBase.getAccounts()) {
        ...
        if (this.fadeTime.isHovered()) {
            ...
            for (CBAccount account : this.mainMenuBase.getAccounts()) {
                ...
                if (bl2) {
                    ...
                    this.mainMenuBase.writeStringToBuffer(account.getDisplayName());
                }
                ++n2;
            }
        }
