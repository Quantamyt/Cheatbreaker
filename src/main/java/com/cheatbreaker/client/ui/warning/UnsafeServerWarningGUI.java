...
public class UnsafeServerWarningGUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float f3 = this.mc.fontRendererObj.getStringWidth(leaveString);
        ...
        if (!this.blocked) {
            this.mc.fontRendererObj.drawStringWithShadow(continueString, (float) ((int) ((float) (this.width / 2 + 20) / f2)), (float) ((int) ((float) (this.height / 2 + 40) / f2)), bl ? -1 : (n3 <= 0 ? -1907998 : -5066062));
        }
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        f2 = 1.0f;
...
//            CheatBreaker.getInstance().playRegular14px.drawCenteredString(line, this.getScaledWidth() / 2.0f, this.getScaledHeight() / 2.0f + 14.0f + (index * CheatBreaker.getInstance().playRegular14px.getFont().getSize() / 2.0f), 0xFFDDDDDD);
            this.mc.fontRendererObj.drawCenteredStringWithShadow(line, (int) ((float) (this.width / 2) / f2), (int) ((float) (this.height / 2 - 70 + (index * 20)) / f2), -1);
            index++;
        }
        if (!this.blocked) {
            this.mc.fontRendererObj.drawCenteredStringWithShadow("Join at " + EnumChatFormatting.BOLD + "your own" + EnumChatFormatting.RESET + " risk!", (int) ((float) (this.width / 2) / f2), (int) ((float) (this.height / 2 - 70 + (index * 20)) / f2), -1);
        }
//        this.mc.fontRendererObj.drawCenteredStringWithShadow(!this.blockedwarn ? "This is a test message." : "You cannot join this server", (int)((float)(this.width / 2) / f2), (int)((float)(this.height / 2 - 70) / f2), -1);
//        this.mc.fontRendererObj.drawCenteredStringWithShadow(!this.blockedwarn ? "This is a test message 2." : "", (int)((float)(this.width / 2) / f2), ((int)((float)(this.height / 2 - 50) / f2)), -1);
//        this.mc.fontRendererObj.drawStringWithShadow(" ", (float)((int)((float)(this.width / 2 - 130) / f2)), (float)((int)((float)(this.height / 2 - 40) / f2)), -1);
//        this.mc.fontRendererObj.drawCenteredStringWithShadow(!this.blockedwarn ? "Join at " + EnumChatFormatting.BOLD +  "your own" + EnumChatFormatting.RESET + " risk!" : "", (int)((float)(this.width / 2) / f2), (int)((float)(this.height / 2 - 30) / f2), -1);
//        this.mc.fontRendererObj.drawStringWithShadow(" ", (float)((int)((float)(this.width / 2 - 130) / f2)), (float)((int)((float)(this.height / 2 - 20) / f2)), -1);
//        this.mc.fontRendererObj.drawStringWithShadow(" ", (float)((int)((float)(this.width / 2 - 130) / f2)), (float)((int)((float)(this.height / 2 - 10) / f2)), -1);
//        this.mc.fontRendererObj.drawStringWithShadow(" ", (float)((int)((float)(this.width / 2 - 130) / f2)), (float)((int)((float)(this.height / 2) / f2)), -1);
        GL11.glPopMatrix();
        this.mc.fontRendererObj.drawCenteredStringWithShadow(title, this.width / 2, this.height / 2 - 90, -1);
        if (this.blocked) {
            this.mc.fontRendererObj.drawCenteredStringWithShadow(leaveString, this.width / 2, this.height / 2 + 30, bl2 ? -1 : -1907998);
        } else {
            this.mc.fontRendererObj.drawStringWithShadow(leaveString, (float) (this.width / 2 - 130), (float) (this.height / 2 + 30), bl2 ? -1 : -1907998);
        }
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        float f = 0.5F;
        String leaveString = this.blocked ? "Leave" : "Get me out of here!";
        float f2 = this.mc.fontRendererObj.getStringWidth(leaveString);
