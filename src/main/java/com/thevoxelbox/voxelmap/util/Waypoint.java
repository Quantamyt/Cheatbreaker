...
public class Waypoint
	...
	public Waypoint(String string, int x, int y, int z, boolean enabled, float red, float green,
					float blue, String imageSuffix, String world, TreeSet<Integer> dimensions, boolean automated,
					boolean bl3) {
		this(string, x, y, z, enabled, red, green, blue, imageSuffix, world, dimensions);
