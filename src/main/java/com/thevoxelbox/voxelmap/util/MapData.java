...
public class MapData {
	private static final int DATABITS = 16;
	private static final int HEIGHTPOS = 0;
	private static final int MATERIALPOS = 1;
	private static final int METADATAPOS = 2;
	private static final int TINTPOS = 3;
	private static final int LIGHTPOS = 4;
	private static final int OCEANFLOORHEIGHTPOS = 5;
	private static final int OCEANFLOORMATERIALPOS = 6;
	private static final int OCEANFLOORMETADATAPOS = 7;
	private static final int OCEANFLOORTINTPOS = 8;
	private static final int OCEANFLOORLIGHTPOS = 9;
	private static final int TRANSPARENTHEIGHTPOS = 10;
	private static final int TRANSPARENTIDPOS = 11;
	private static final int TRANSPARENTMETADATAPOS = 12;
	private static final int TRANSPARENTTINTPOS = 13;
	private static final int TRANSPARENTLIGHTPOS = 14;
	private static final int BIOMEIDPOS = 15;
	public Point[][] points;
	...
	public class Segment {
		...
		public void flood() {
			...
			while (candidatePoints.size() > 0) {
				MapData.Point point = candidatePoints.remove(0);
