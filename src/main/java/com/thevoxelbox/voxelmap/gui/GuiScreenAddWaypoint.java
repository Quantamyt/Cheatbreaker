...
public class GuiScreenAddWaypoint
	...
	protected void keyTyped(char par1, int par2) {
		this.waypointName.keyTyped(par1, par2);
		this.waypointX.keyTyped(par1, par2);
		this.waypointZ.keyTyped(par1, par2);
		this.waypointY.keyTyped(par1, par2);
		if (par1 == '\t') {
	...
	protected void mouseClicked(int par1, int par2, int mouseButton) {
		if (!this.choosingColor) {
			...
			this.waypointName.mouseClicked(par1, par2, mouseButton);
			this.waypointX.mouseClicked(par1, par2, mouseButton);
			this.waypointZ.mouseClicked(par1, par2, mouseButton);
			this.waypointY.mouseClicked(par1, par2, mouseButton);
