...
public class ShaderMacros {
    ...
    public static String getOs() {
        ...
        switch (ShaderMacros.NamelessClass846372605.$SwitchMap$net$minecraft$util$Util$EnumOS[os.ordinal()]) {
            case 1:
    ...
    static class NamelessClass846372605 {
        static final int[] $SwitchMap$net$minecraft$util$Util$EnumOS = new int[EnumOS.values().length];

        static {
            try {
                $SwitchMap$net$minecraft$util$Util$EnumOS[EnumOS.WINDOWS.ordinal()] = 1;
            } catch (NoSuchFieldError var3) {
                ;
            }

            try {
                $SwitchMap$net$minecraft$util$Util$EnumOS[EnumOS.OSX.ordinal()] = 2;
            } catch (NoSuchFieldError var2) {
                ;
            }

            try {
                $SwitchMap$net$minecraft$util$Util$EnumOS[EnumOS.LINUX.ordinal()] = 3;
