...
public class GuiShaders extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.OLD_HAND_LIGHT, btnX, 6 * stepY + baseY, btnWidth, btnHeight));
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button instanceof GuiButtonEnumShaderOption) {
                ...
                switch (GuiShaders.NamelessClass1764978854.$SwitchMap$shadersmod$client$EnumShaderOption[var11.getEnumShaderOption().ordinal()]) {
                    case 1:
                    ...
                    case 4:
                        var12 = Shaders.configRenderResMul;
                        var14 = QUALITY_MULTIPLIERS;
                        names = QUALITY_MULTIPLIER_NAMES;
                        index = getValueIndex(var12, var14);
                    ...
                    case 5:
                        var12 = Shaders.configShadowResMul;
                        var14 = QUALITY_MULTIPLIERS;
                        names = QUALITY_MULTIPLIER_NAMES;
                        index = getValueIndex(var12, var14);
                    ...
                    case 6:
                        var12 = Shaders.configHandDepthMul;
                        var14 = HAND_DEPTH_VALUES;
    ...
    static class NamelessClass1764978854 {
