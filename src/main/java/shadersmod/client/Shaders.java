...
public class Shaders {
    ...
    private static void setEnumShaderOption(EnumShaderOption eso, String str) {
        ...
        switch (Shaders.NamelessClass363063280.$SwitchMap$shadersmod$client$EnumShaderOption[eso.ordinal()]) {
            case 1:
...
//        }
    ...
    private static void printChat(String str) {
        mc.ingameGUI.getChatGUI().func_146227_a(new ChatComponentText(str));
    }
    ...
    static class NamelessClass363063280 {
